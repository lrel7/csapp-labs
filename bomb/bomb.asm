...
0000000000400ee0 <phase_1>:
  400ee0:	48 83 ec 08          	sub    $0x8,%rsp  # rsp -= 8
  400ee4:	be 00 24 40 00       	mov    $0x402400,%esi  # esi <- 0x402400
  400ee9:	e8 4a 04 00 00       	call   401338 <strings_not_equal>  # call <strings_not_equal> function
  400eee:	85 c0                	test   %eax,%eax  # test if eax is 0
  400ef0:	74 05                	je     400ef7 <phase_1+0x17>  # if eax is 0, jump to 400ef7
  400ef2:	e8 43 05 00 00       	call   40143a <explode_bomb>  # else, if eax is not 0, i.e. the strings are not equal, explode the bomb
